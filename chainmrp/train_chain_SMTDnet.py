...
save_path = os.path.join(dir, "checkpoints", "SMTDmodel_" + experiment_time + ".ckpt")


env = ChainMRP(prob=1.)
answerNet = ChainAnswerNet(obs_dim=env.obs_dim, max_time=6, scope="TDnet", softmax=True)
